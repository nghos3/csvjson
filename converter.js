...
let i;
// These are the variables for first json inside the array parameters
// contains salt and second one contains salt
const countries = [];
...
// These variables are for regions array inside will
// contain Fat, Protein and Carbohydrate  respectively
const regions = [];
